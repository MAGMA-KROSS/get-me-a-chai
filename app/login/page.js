        ...
        <div style={{boxShadow: '0 0 10px #ffffff'}} className="w-full rounded-lg border md:mt-0 sm:max-w-md xl:p-0 border-gray-400">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <button type="submit" className="text-white bg-gradient-to-br w-full py-3 px-6 font-bold hover:scale-105 from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 duration-300 rounded-lg text-lg cursor-pointer text-center me-2 mb-2">Login</button>
